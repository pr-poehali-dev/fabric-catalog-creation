...
const FabricCategory = ({ title, icon, count }: { title: string; icon: string; count: number }) => {
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-xl text-muted-foreground mb-6">
                Найдите идеальную ткань для вашего проекта из нашей обширной коллекции
              </p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Все ткани проходят тщательный контроль качества</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Доставка заказов в любую точку России</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Более 250 видов тканей для любых нужд</p>
            </div>
          </div>
        </div>
      </section>
